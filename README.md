...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-10 23:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c7f8dcbe-c017-4683-bef3-733b0f2511ee.git
$ cd c7f8dcbe-c017-4683-bef3-733b0f2511ee
```
